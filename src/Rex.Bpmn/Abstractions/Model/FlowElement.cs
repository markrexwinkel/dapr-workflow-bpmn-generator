...
[XmlType("tFlowElement", Namespace = Namespaces.Bpmn)]
[XmlRoot("flowElement", Namespace = Namespaces.Bpmn, IsNullable = false)]
public abstract class FlowElement : BaseElement
{
    private readonly Lazy<Collection<XmlQualifiedName>> _categoryValueRefs = new();
