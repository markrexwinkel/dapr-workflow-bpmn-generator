...
[XmlType("tDefinitions", Namespace = Namespaces.Bpmn)]
[XmlRoot("definitions", Namespace = Namespaces.Bpmn, IsNullable = false)]
public class Definitions
{
    private readonly Lazy<Collection<XmlAttribute>> _extensionAttributes = new();
    private readonly Lazy<Collection<Import>> _imports = new();
    private readonly Lazy<Collection<Extension>> _extensions = new();
    private readonly Lazy<Collection<RootElement>> _rootElements = new();
    private readonly Lazy<Collection<BpmnDiagram>> _bpmnDiagrams = new();
    private readonly Lazy<Collection<Relationship>> _relationships = new();
    ...
    [XmlElement("BPMNDiagram", Namespace = Namespaces.BpmnDI)]
