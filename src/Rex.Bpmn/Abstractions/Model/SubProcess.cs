...
[XmlType("tSubProcess", Namespace = Namespaces.Bpmn)]
[XmlRoot("subProcess", Namespace = Namespaces.Bpmn, IsNullable = false)]
public class SubProcess : Activity, IFlowElements
{
