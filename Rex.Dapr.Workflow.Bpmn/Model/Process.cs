...
namespace Rex.Bpmn.Model
{
    ...
    public class Process : CallableElement
    {
        ...
        private readonly Lazy<Collection<CorrelationSubscription>> _correlationSubscriptions = new Lazy<Collection<CorrelationSubscription>>();
        private readonly Lazy<Collection<XmlQualifiedName>> _supports = new Lazy<Collection<XmlQualifiedName>>();
